    ...
    <div className="fixed inset-0 bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="container mx-auto px-4 py-6 max-w-2xl space-y-5">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-5 space-y-4">
              <div className="flex items-center justify-between pb-4 border-b border-gray-200">
                ...
                <div className="flex items-center gap-3 bg-gray-50 rounded-lg p-1 border border-gray-200">
                  <Button size="sm" variant="ghost" onClick={() => setQuantity(Math.max(1, quantity - 1))} className="h-8 w-8 rounded hover:bg-gray-200">
                    <Minus className="h-4 w-4 text-gray-700" />
                  </Button>
                  <span className="w-10 text-center font-medium text-gray-900">{quantity}</span>
                  <Button size="sm" variant="ghost" onClick={() => setQuantity(quantity + 1)} className="h-8 w-8 rounded hover:bg-gray-200">
            ...
            <Button className="w-full bg-green-600 hover:bg-green-700 text-white h-12 text-sm font-medium rounded-lg transition-colors" size="lg" onClick={handleAddToCart}>
